...
namespace ImGui
{
	...
	// Cursor / Layout
	IMGUI_API void          Separator(float heightdistance = 0);                                                        // separator, generally horizontal. inside a menu bar or in horizontal layout mode, this becomes a vertical separator.
